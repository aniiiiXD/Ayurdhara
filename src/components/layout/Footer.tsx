    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-white font-semibold text-lg mb-4">Login Portals</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/login/patient" className="hover:text-white transition-colors duration-200">
                  Patient Login
                </Link>
              </li>
              <li>
                <Link to="/login/doctor" className="hover:text-white transition-colors duration-200">
                  Doctor Login
                </Link>
              </li>
              <li>
                <Link to="/login/student" className="hover:text-white transition-colors duration-200">
                  Student Login
                </Link>
              </li>
            </ul>
